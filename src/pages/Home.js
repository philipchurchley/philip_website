...
function Home() {
  ...
  useEffect(() => {
    ...
    if (opacity === 1) {
      navRef.current.style.transform = "translateY(-100%)"; // Move navbar out of view
    ...
    // Pause video when opacity becomes 0
      ...
      navRef.current.style.transform = "translateY(0)"; // Bring it back
      if (videoRef.current) {
      ...
      <div className="container" ref={containerRef}>
        ...
        <section className="section section4" ref={videoContainerRef}>
          <video width="70%" ref={videoRef}>
            <source src="/hi_im_philip.mp4" type="video/mp4" />
